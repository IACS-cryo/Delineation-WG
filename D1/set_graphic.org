...
#+CAPTION: Subset of West Antarctica including Pine Island Bay and ice shelf showing how many (of RGI, BedMachin, and the ESA CCI Landcover dataset) masks overlap within a given region. This example figure highlights the inconsistencies between various products, making intercomparison challenging.

[[file:./figs_tmp/overlap_AQ.png]]
